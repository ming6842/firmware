...
int main(int argc, char* argv[])
{
	...
	for (;;) 
    {
		...
		mavlink_msg_global_position_int_pack(1, 220, &msg, microsSinceEpoch(),  22.999326 * 1E7,
		120.219416 * 1E7, 100*1000, 10 * 1000, 1*100, 1*100, 1 * 100, 45);
		/*
		(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint32_t time_boot_ms, 
		int32_t lat, int32_t lon, int32_t alt,	int32_t relative_alt, int16_t vx, int16_t vy, 
